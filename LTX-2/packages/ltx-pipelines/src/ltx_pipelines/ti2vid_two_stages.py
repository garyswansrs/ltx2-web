...
class TI2VidTwoStagesPipeline:
    ...
    def __call__(  # noqa: PLR0913
        ...
        # Note: text_encoder is cached by ModelLedger - no need to delete
        ...
        # Note: transformer cached by ModelLedger - clear cache only if needed
        ...
        # Note: Models are cached by ModelLedger - no need to delete
        # Call model_ledger.clear_cache() if you need to free VRAM
